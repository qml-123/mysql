...
class TeaController extends AbstractActionController
{
	...
	public function pasubmitAction()
	{
		...
		$uid= $_POST['form-field-2'];
		$cid = $_POST['form-field-3'];
		// $newModel->exec('update Raletionta set result="allow" where cid="'.$cid.'" and taid="'.$uid.'"');
		$newModel->exec('update Raletionta set result="allow" where cid="1" and taid="777777"');
		return $this->redirect()->toRoute('tea/defaults',array('controller'=>'Tea','action'=>'tacheck'));
	}
	...
	public function addstuAction(){
		...
		$tableGateway = new \Zend\Db\TableGateway\TableGateway('Student',$dbAdapter, null, $resultSetPrototype);
		...
		return $this->redirect()->toRoute('tea/defaults',array('controller'=>'Tea','action'=>'ssub'));
	...
	public function addteaAction()
	{
		...
		$tableGateway = new \Zend\Db\TableGateway\TableGateway('Teacher',$dbAdapter, null, $resultSetPrototype);
